...
export default function ModuleGrid({ modules, selectedModuleId, onSelect }: ModuleGridProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="flex items-center space-x-2 mb-3">
        ...
        <h4 className="text-sm font-mono text-gray-200 tracking-wide uppercase">Module Array</h4>
        <div className="flex-1 h-px bg-gradient-to-r from-gray-600 to-transparent" />
        <span className="text-xs font-mono text-gray-500">{moduleArray.length} MODULES</span>
      </div>
